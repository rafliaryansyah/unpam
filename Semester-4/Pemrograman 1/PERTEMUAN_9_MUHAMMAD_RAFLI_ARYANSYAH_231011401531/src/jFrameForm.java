...
public class jFrameForm extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            SKS = Integer.parseInt(jComboBox1.getSelectedItem().toString());
            Kehadiran = Integer.parseInt(jTextField3.getText());
            ...
            // Hitung nilai akhir
            double nilaiAkhir = (Kehadiran * 0.10) + (Tugas * 0.20) + (UTS * 0.30) + (UAS * 0.40);
            ...
            jTextArea1.setText("Error: Pastikan semua input angka diisi dengan benar!");
        }
